    ...
    */
    ...
    getRate = async (from, to, amount, decimalsFrom, decimalsTo) => {
        ...
        if (amount > 0 && from !== to) {
            ...
            const router = new this.props.web3.eth.Contract(UNIRouterABI, UniswapV2Router02)
                        ...
                        (
                            <>
                                ...
                                <FormControl>
                                    ...
                                    <br />
                                    {
                                        this.props.exchangePortalAddress === ExchangePortalAddressV7
                                            ?
                                            (
                                            ...
                                            :
                                            (
                                                <Alert status='error'  >Please update portal to latest version, for enable UniSwap DEX in your fund</Alert>
                                            )
                                    }
